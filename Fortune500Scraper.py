...
responseMain = urllib2.urlopen('http://money.cnn.com/magazines/fortune/fortune500/2013/full_list')
...
f.writerow(["Rank", "Name", "Revenues", "Profits", "Assets", "Employees", "Total stockholders' equity", "Total return to investors: 1 yr. annual rate (%)" ,"Total return to investors: 5 yr. annual rate (%)", "Total return to investors: 10 yr. annual rate (%)", "EPS (2012$)", "EPS 1 yr", "EPS 5 yr", "EPS 10 yr", "ProfitRevenue %", "ProfitAssets %", "ProfitStockholder'sEquity %", "State", "Industry"])
...
for company in f500list.find_all('a'):
	...
	f.writerow([rank, name, revenue, profits, assets, employees, SHEq, RTI, RTI5, RTI10, EPS, EPS1, EPS5, EPS10, PCTR, PCTA, PCTSHE, State, Indus])